...
const Leads = () => {
  ...
  const PAGE_SIZE = 50;
  const { data: paginatedData, isLoading, refetch } = useLeadsPaginated(page, PAGE_SIZE);
  ...
  return (
    <AppLayout title="All Leads" subtitle={`${filtered.length} leads found`} actions={<Actions />}>
