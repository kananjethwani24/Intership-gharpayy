        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 10 }}>
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <h3 style={{ fontFamily: T.sans, fontWeight: 800, fontSize: 14, color: '#111827', margin: 0, letterSpacing: '-0.01em' }}>{pg.name.toUpperCase()}</h3>
      ...
      <div style={{ minHeight: '100vh', background: T.bg0, color: T.t0, fontFamily: T.sans, paddingBottom: 80 }}>
        ...
        <div style={{ maxWidth: 1440, margin: '0 auto', padding: '16px', display: 'flex', gap: 16, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div className={viewMode === 'grid' ? 'inventory-grid' : ''} style={{ display: viewMode === 'list' ? 'flex' : undefined, flexDirection: viewMode === 'list' ? 'column' : undefined, gap: 12 }}>
              {filtered.map((pg, idx) => {
